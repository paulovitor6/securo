...
async def import_snapshot(
    ...
    updated = 0
    values_recorded = 0
    errors: list[AssetSnapshotImportRowError] = []
    ...
    for i, row in enumerate(reader, start=2):
        ...
        try:
            ...
            errors.append(AssetSnapshotImportRowError(row=i, message=str(e)))
            continue
    ...
    await session.commit()
    return AssetSnapshotImportResult(created=created, updated=updated, values_recorded=values_recorded, errors=errors)
